...
String credentials[][2] = {
    {"PLDTHOMEFIBR2XuQP", "PLDTWIFIFk5e8"},
...
// Info about these settings at https://github.com/JChristensen/Timezone#coding-timechangerules
TimeChangeRule myStandardTime = {"PST", Last, Sun, Mar, 0, 8 * 60}; // Philippine Standard Time (UTC+8)
TimeChangeRule myDaylightSavingsTime = {"PST", Last, Sun, Mar, 0, 8 * 60}; // No Daylight Savings Time, same as Standard Time
